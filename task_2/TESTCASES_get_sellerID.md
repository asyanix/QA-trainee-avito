...
Тест-кейс протестирован, в ходе анализа был обнаружен баг: GET-запрос с предусловием `Accept: application/json` и нулевым значением sellerID, возвращает ответ не в формате JSON, а в формате HTML. 
